...
function renderProducts(filter = '', sort = '') {
    ...
    const headerContainer = El({
        element: 'div',
        className: 'bg-white shadow-md p-4 absolute top-0 right-0 left-0 mx-auto',
        children: [
            ...
            El({
                ...
                children: [
                    El({
                        element: 'button', className: 'flex flex-col items-center text-gray-600 hover:text-blue-500', children: [
                            El({
                                element: 'div', className: 'border-none px-2 py-2 rounded-full', children: [
                    ...
                    El({
                        element: 'button', className: 'flex flex-col items-center text-gray-600 hover:text-blue-500', children: [
                            El({
                                element: 'div', className: 'border-none px-1 py-1 rounded-full', children: [
            ...
            El({
                element: 'div',
                className: 'flex space-x-2 mt-2 overflow-y-auto',
                children: [
                    El({
                        element: 'div', className: 'border p-2 rounded-lg', children: [
                    ...
                    El({ element: 'button', className: 'border p-2 rounded-lg', children: ['New Balance'] }),
                    El({ element: 'button', className: 'border p-2 rounded-lg', children: ['Converse'] }),
                ],
            })]
    });
    ...
    const footer = El({
        element: 'div',
        className: 'flex justify-around items-center bg-gray-100 p-2 fixed bottom-0 right-0 left-0 w-full',
        children: [
            El({
                element: 'a', className: 'flex flex-col items-center', href: "/home", children: [
                    El({ element: 'img', className: 'w-6 h-6', src: "public/house-door-fill.png", alt: "Home" }),
                    El({ element: 'span', className: 'text-sm', children: ["Home"] }),
                ]
            }),
            El({
                element: 'div', className: 'flex flex-col items-center', children: [
    ...
    const productList = El({
        ...
        children: [headerContainer, footer]
    ...
    fetchProducts().then((data) => {
        ...
        filteredProducts.forEach(product => {
            ...
            const productDiv = El({
                ...
                href: "http://localhost:5575/Products/" + product.id,
